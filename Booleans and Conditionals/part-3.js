...
if ((commandOverride === false) && (readyForTakeoff === false)) {
    console.log("commandOverride disabled!")
    console.log("Failure. Liftoff will not commence. Please contact your Administrator.");
} else if ((commandOverride === true) && (readyForTakeoff === false)) {
    console.log("commandOverride enabled!")
    console.log("Liftoff will commence anyway, GLHF!");
} else if ((commandOverride === false) && (readyForTakeoff === true)) {
    console.log("commandOverride disabled!")
    console.log("All systems Go, taking off in T-Minus...");
} else if ((commandOverride === true) && (readyForTakeoff === true)) {
    console.log("commandOverride enabled!")
    console.log("All systems Go, taking off in T-Minus...");
}
